...
export default {
  list: {
    ...
    owned_users: '所属用户',
    workflow_define_count: '作业定义数',
    process_instance_running_count: '正在运行的作业数',
    description: '描述',
    create_time: '创建时间',
    update_time: '更新时间',
    operation: '操作',
  ...
  workflow: {
    ...
    create_workflow: '创建作业',
    import_workflow: '导入作业',
    workflow_name: '作业名称',
    ...
    recover_tolerance_fault_process: '恢复被容错的作业',
    ...
    project_name: '项目名称',
    project_tips: '请选择项目',
    workflow_relation_no_data_result_title: '作业关系不存在',
    workflow_relation_no_data_result_desc:
      '目前没有任何作业，请先创建作业，再访问该页面'
  },
  task: {
    cancel_full_screen: '取消全屏',
  ...
  dag: {
    ...
    online_directly: '是否上线作业定义',
    update_directly: '是否更新作业定义',
  ...
  node: {
    ...
    success: '成功',
    failed: '失败',
    backfill_tips: '新创建子作业还未执行，不能进入子作业',
    task_instance_tips: '该任务还未执行，不能进入子作业',
    ...
    emr_flow_define_json_tips: '请输入作业定义',
